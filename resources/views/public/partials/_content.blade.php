                            ...
                            <div class="contact_form">
                                    ...
                                    <div class="col-xs-5">
                                        <div class="form-group">
                                            <input name="firstname" class="form-control" type="text" placeholder="Firstname"/>
                                    ...
                                    <div class="col-xs-5">
                                        <div class="form-group">
                                            <input name="lastname" class="form-control" type="text" placeholder="Lastname" />
                                            <p class="help-block"></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-2">
                                        <div class="form-group">
                                            <input name="middleinitial" class="form-control" type="text" placeholder="MI"/>
                                            <p class="help-block"></p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <button type="submit" class="subscribe_btn" id="subscribe_btn_11">SIGN UP NOW!</button>
                                    </div>
                                </div>

                            </div>
                        </div>
                       {{--<h6 class="note_st">*Note: Bundle ends in two weeks from now.</h6>--}}
                       {!! Form::close() !!}
                    </div>
           	</div>
           </div>
	...
	<div class="container">
		<div class="sixteen columns">
           ...
           <div class="four columns  alpha">
		        <img src="{{ asset('images/2_corporate/1.png') }}" alt="">
           ...
           <div class="four columns  ">
		        <img src="{{ asset('images/2_corporate/2.png') }}" alt="">
           ...
           <div class="four columns  ">
		        <img src="{{ asset('images/2_corporate/3.png') }}" alt="">
           ...
           <div class="four columns  omega">
		        <img src="{{asset('images/2_corporate/4.png')}}" alt="">
...
<div class="amazing_style">
	<div class="container">
		<div class="sixteen columns">
			...
			<span> <img src="{{asset('images/2_corporate/promo-image.png')}}" class="pub_st" alt=""></span>
		</div>
	</div><!-- container -->
</div>
		...
		<div class="sixteen columns">
            <div class="gstyle">
               ...
               <div class="one-third column   omega">
                    <div class="th1_style">
                        <div class="a_bloc1_style">
                            <p class="a1_style">Company</p>
                            <p class="a2_style">Get All The Features</p>
                        </div>
                        ...
                        <p class="a3_style"><span class="fsc1">70$</span><sup>/m</sup> </p>
...
<div class="awesome_style">
	<div class="container">
		<div class="sixteen columns">
			...
			<div class="via_st">
				<img src="{{asset('images/2_corporate/stars.original.png')}}" alt="">
